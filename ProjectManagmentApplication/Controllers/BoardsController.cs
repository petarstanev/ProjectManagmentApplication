...
//            }
//            //Board board = db.Boards.Include(e => e.Columns.Select(c => c.Tasks)).Include(b => b.Members).SingleOrDefault(e => e.BoardId == id);
//            if (board == null)
//            {
//                return HttpNotFound();
//            }
...
//            {
//                SessionContext sx = new SessionContext();
//                board.User.UserId = sx.GetUserId();
...
//                    break;
//                case BoardType.Team:
//                    User foundUser = board.Members.FirstOrDefault(u => u.UserId == sx.GetUserId());
//                    result = foundUser != null || CheckAdministrator(board);
//                    break;
//                default:
//                    result = true;
//                    break;
